/* 레퍼런스간의 형변환 )
 *  1.업캐스팅이란?
 *    상속관계에서 자손타입이 부모 조상타입으로 형변환이 이루어 지는 것을 업캐스팅이라고 한다.
 *    업캐스팅은 자바 컴파일러에 의해서 자동형 변환을 해준다.
 */
class Mother11{//extends Object이 생략됨
	void m11() {
...
class Child11 extends Mother11{
	void ch11() {
		System.out.println("자손클래스에서 정의된 ch11() 메서드");
	}
}
